...
function BranchInfo() {
    ...
    if (!branch) return <p className="text-center py-6 text-gray-500">Loading...</p>;
    ...
    return (
        <>
            <div className="p-6 max-w-3xl mx-auto">
                <h2 className="text-2xl font-bold text-center text-gray-800">Branch Information</h2>
                    ...
                    <table className="w-full text-sm text-left text-gray-700">
                        <tbody>
                            <tr className="border-b">
                                <th className="px-6 py-3 font-semibold bg-gray-100">Branch Name</th>
                                <td className="px-6 py-3">{branch.branchName}</td>
                            </tr>
                            <tr className="border-b">
                                <th className="px-6 py-3 font-semibold bg-gray-100">Client</th>
                                <td className="px-6 py-3">{branch.client?.clientName || branch.client}</td>
                            </tr>
                            <tr className="border-b">
                                <th className="px-6 py-3 font-semibold bg-gray-100">Location</th>
                                <td className="px-6 py-3">
                                    {[branch.address?.barangay, branch.address?.city, branch.address?.province, branch.address?.region]
                                        .filter(Boolean)
                                        .join(', ')}
                                </td>
                            </tr>
                ...
                <div className="flex justify-between items-center mt-6">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg shadow ${currentIndex >= branches.length - 1
                            ? "bg-gray-300 text-gray-600 cursor-not-allowed"
                            : "bg-blue-600 text-white hover:bg-blue-700"
                            }`}
                    >
                        ...
                        <div className="flex justify-between items-center p-6 border-b">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Branch: {branch.branchName} • Total Bookings: {bookings.length}
